#!/usr/bin/env python3
"""Stage and optionally package the @lpalbou/codex-unleashed npm module."""
...
CODEX_NPM_NAME = "@lpalbou/codex-unleashed"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@lpalbou/codex-unleashed`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@lpalbou/codex-unleashed-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@lpalbou/codex-unleashed-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@lpalbou/codex-unleashed-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@lpalbou/codex-unleashed-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@lpalbou/codex-unleashed-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@lpalbou/codex-unleashed-win32-arm64",
        "npm_tag": "win32-arm64",
