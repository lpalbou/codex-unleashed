...
/// Settings that govern if and what will be written to `~/.codex-unleashed/history.jsonl`.
...
pub struct Tui {
    ...
    /// Use `/theme` in the TUI or see `$CODEX_UNLEASHED_HOME/themes` for custom themes.
    #[serde(default)]
