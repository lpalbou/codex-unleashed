...
/// - user      `${CODEX_UNLEASHED_HOME}/config.toml`
...
pub async fn load_config_layers_state(
    ...
    // Add a layer for the Codex Unleashed home config.toml if it exists. Note
    // if the file exists, but is malformed, then this error should be
