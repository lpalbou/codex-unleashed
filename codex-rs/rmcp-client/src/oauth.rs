...
//!
//! If the keyring is not available or fails, we fall back to
//! {Codex Unleashed home}/.credentials.json.
...
mod tests {
    ...
    impl TempCodexHome {
        fn new() -> Self {
            ...
            let dir = tempdir().expect("create Codex Unleashed home temp dir");
            unsafe {
