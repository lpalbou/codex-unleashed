...
use crate::version::UPSTREAM_VERSION;
...
impl SessionHeaderHistoryCell {
    ...
    pub(crate) fn new_with_style(
        ...
        Self {
            ...
            show_fast_status,
            directory,
            startup_date: current_startup_date(),
        }
    }
...
impl HistoryCell for SessionHeaderHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let fork_line = format!("Fork of {UPSTREAM_NAME} v{UPSTREAM_VERSION} by {FORK_AUTHOR}.");
        let purpose_line =
...
#[cfg(test)]
fn current_startup_date() -> String {
    "<DATE>".to_string()
}
...
///   register it as an MCP server via `codex-unleashed mcp add`.
